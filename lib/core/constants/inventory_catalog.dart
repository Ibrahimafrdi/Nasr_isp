...
const List<InventoryCatalogEntry> kInventoryCatalog = [
  ...
  // Fiber stock
  InventoryCatalogEntry(name: 'Fiber Router', category: InventoryCategory.equipment, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 15, reorderLevel: 5, unitCost: 4000),
  InventoryCatalogEntry(name: 'Fiber Cable', category: InventoryCategory.consumable, connectionType: InventoryConnectionType.fiber, unit: 'meters', quantityInStock: 1000, reorderLevel: 200, unitCost: 20),
  InventoryCatalogEntry(name: 'Patch Cord', category: InventoryCategory.consumable, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 100, reorderLevel: 20, unitCost: 250),
  InventoryCatalogEntry(name: '1x8 Splitter', category: InventoryCategory.equipment, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 10, reorderLevel: 3, unitCost: 1200),
  InventoryCatalogEntry(name: '1x4 Splitter', category: InventoryCategory.equipment, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 10, reorderLevel: 3, unitCost: 800),
  InventoryCatalogEntry(name: '1x2 Splitter', category: InventoryCategory.equipment, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 10, reorderLevel: 3, unitCost: 500),
  InventoryCatalogEntry(name: 'Large DP Box', category: InventoryCategory.equipment, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 8, reorderLevel: 2, unitCost: 3500),
  InventoryCatalogEntry(name: 'Small DP Box', category: InventoryCategory.equipment, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 8, reorderLevel: 2, unitCost: 1800),
  InventoryCatalogEntry(name: 'Splicing Sleeve', category: InventoryCategory.consumable, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 200, reorderLevel: 50, unitCost: 15),
  InventoryCatalogEntry(name: 'Yellow Tape', category: InventoryCategory.consumable, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 50, reorderLevel: 10, unitCost: 60),
  InventoryCatalogEntry(name: 'White Tape', category: InventoryCategory.consumable, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 50, reorderLevel: 10, unitCost: 60),
  InventoryCatalogEntry(name: 'Double Sided Tape', category: InventoryCategory.consumable, connectionType: InventoryConnectionType.fiber, unit: 'pcs', quantityInStock: 50, reorderLevel: 10, unitCost: 80),
