...
class FakeInstallationRepository implements InstallationRepository {
  ...
  @override
  Future<List<InstallationEntity>> getInstallations({String? status, String? connectionType, String? employeeId, String? searchQuery}) async => [];
  @override
...
void main() {
  setUp(() {
    ...
    final getInstallationsByCustomer = GetInstallationsByCustomer(installationRepo);
    ...
    getIt.registerSingleton<EmployeeBloc>(EmployeeBloc(
